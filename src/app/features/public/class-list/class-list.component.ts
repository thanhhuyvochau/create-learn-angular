    ...
    <div class="class-list-page">
      ...
      <div class="page-header">
        <div class="header-content">
          <h1 class="header-title">Chinh phuc chuong trinh quoc te cung AlgoCore</h1>
          <p class="header-description">
            Lop nhom nho/1-1 theo lo trinh IGCSE • AS/A Level • IBDP • AP.
            Hoc bam syllabus, luyen exam-style, theo doi tien do va muc tieu diem so ro rang.
          </p>
        </div>
      </div>
